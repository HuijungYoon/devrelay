...
IDE + CLI plugin for Google Antigravity (`agy`). MCP: `redmine-devrelay@0.7.3` (read + write, dry-run confirm gate).
...
`mcp_config.json` pins `npx -y redmine-devrelay@0.7.3` and passes `REDMINE_*`.
