...
**MCP 패키지:** `redmine-devrelay@0.7.4` (조회 + 쓰기, dry-run 확인 게이트)

## Components

- **MCP:** `npx -y redmine-devrelay@0.7.4`
...
Plugin path: `plugins/cursor` · `mcp.json`은 `redmine-devrelay@0.7.4`를 가리킵니다.
